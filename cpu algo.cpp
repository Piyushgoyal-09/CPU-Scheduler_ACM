...
public:
Scheduler(vector<Process>& procs) : processes(procs), current_time(0) {}
...
//	vector<Process> processes = {
        Process p1(1, 0, 8, 4);   // Process ID, Arrival Time, Burst Time, Priority
        Process p2(2, 1, 4, 2);
    	Process p3(3, 2, 9, 1);
        Process p4(4, 3, 5, 3);
        vector<Process>processes;
    ...
    // Example of using different scheduling algorithms
